...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    scheduled_desc: "Automatically scan/download subtitles on a schedule",
    cron_label: "Cron Expression",
    cron_placeholder: "e.g. 0 2 * * *",
    cron_hourly: "Every Hour",
    cron_daily: "Daily at 3 AM",
    cron_weekly: "Weekly Mon 3 AM",
    last_run: "Last Run",
    next_run: "Next Run",
    ...
    schedule_delete_confirm: "Delete this scheduled task?",
  ...
  zh: {
    ...
    pending_review: "\u5f85\u5ba1\u6838",
    scheduled: "\u5b9a\u65f6\u4efb\u52a1",
    scheduled_desc: "\u6309\u65f6\u81ea\u52a8\u626b\u63cf/\u4e0b\u8f7d\u5b57\u5e55",
    cron_label: "Cron \u8868\u8fbe\u5f0f",
    cron_placeholder: "\u4f8b\u5982 0 2 * * *",
    cron_hourly: "\u6bcf\u5c0f\u65f6",
    cron_daily: "\u6bcf\u5929 3 \u70b9",
    cron_weekly: "\u6bcf\u5468\u4e00 3 \u70b9",
    last_run: "\u4e0a\u6b21\u6267\u884c",
    ...
    schedule_save: "\u4fdd\u5b58\u5b9a\u65f6\u4efb\u52a1",
    schedule_delete: "\u5220\u9664\u5b9a\u65f6\u4efb\u52a1",
    schedule_delete_confirm: "\u786e\u5b9a\u5220\u9664\u8be5\u5b9a\u65f6\u4efb\u52a1\uff1f",
    schedule_saved: "\u5b9a\u65f6\u4efb\u52a1\u5df2\u4fdd\u5b58",
    schedule_deleted: "\u5b9a\u65f6\u4efb\u52a1\u5df2\u5220\u9664",
    schedule_save_failed: "\u4fdd\u5b58\u5b9a\u65f6\u4efb\u52a1\u5931\u8d25",
    schedule_delete_failed: "\u5220\u9664\u5b9a\u65f6\u4efb\u52a1\u5931\u8d25",
    schedule_mode: "\u6a21\u5f0f",
    schedule_skipped: "\u5df2\u8df3\u8fc7",
    schedule_never_run: "\u4ece\u672a",
  },
};
