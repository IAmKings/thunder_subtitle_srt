...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Debug Subtitle
    debug: "Debug",
    debug_subtitle: "Debug Subtitle",
    debug_title: "Subtitle Debug Report",
    debug_copy: "Copy Report",
    debug_copied: "Copied!",
    debug_close: "Close",
    debug_section_file_info: "File Info",
    debug_section_srt_parse: "SRT Parse",
    debug_section_deductions: "Deductions",
    debug_section_ai_flags: "AI Flags",
    debug_section_duration_match: "Duration Match",
    debug_loading: "Loading debug info...",
    debug_error: "Debug failed",
    debug_no_file: "File not found",
    debug_empty: "No issues found",
    debug_subtitle_enabled: "Subtitle Debug Button",
    debug_subtitle_enabled_hint: "Show debug button on each subtitle item in verification page",
    debug_file_path: "Path",
    debug_file_size: "Size",
    debug_encoding: "Encoding",
    debug_score: "Score",
    debug_status: "Status",
    debug_match_count: "Match Count",
    debug_total_lines: "Total Lines",
    debug_unmatched_offset: "Unmatched Offset",
    debug_valid_lines: "Valid Lines",
    debug_srt_match_count: "SRT Match Count",
    debug_unmatched_tail: "Unmatched Tail Bytes",
    debug_duration_ratio: "Duration Ratio",
    debug_scan_log: "Scan Log",
    debug_cn_ratio: "Chinese Ratio",
    debug_entry_count: "Entries",
    debug_last_index: "Last Index",
    debug_last_end_time: "Last Subtitle Time",
    debug_deduction_items: "Deductions",
    debug_file_diagnosis: "File Diagnosis",
  ...
  zh: {
    ...
    debug_copied: "已复制!",
    debug_close: "关闭",
    debug_section_file_info: "文件信息",
    debug_section_srt_parse: "SRT 解析",
    debug_section_deductions: "扣分明细",
    debug_section_ai_flags: "AI 标记",
    debug_section_duration_match: "片长匹配",
    debug_loading: "加载调试信息中...",
    debug_error: "调试失败",
    debug_no_file: "文件不存在",
    debug_empty: "无问题",
    debug_subtitle_enabled: "字幕调试按钮",
    debug_subtitle_enabled_hint: "在审核页每个字幕项上显示调试按钮",
    debug_file_path: "路径",
    debug_file_size: "大小",
    debug_encoding: "编码",
    debug_score: "评分",
    debug_status: "状态",
    debug_match_count: "匹配数",
    debug_total_lines: "总行数",
    debug_unmatched_offset: "未匹配偏移",
    debug_valid_lines: "有效行数",
    debug_srt_match_count: "SRT 匹配数",
    debug_unmatched_tail: "未匹配尾部字节",
    debug_duration_ratio: "片长匹配度",
    debug_scan_log: "扫描日志",
    debug_cn_ratio: "中文占比",
    debug_entry_count: "条目数",
    debug_last_index: "最后序号",
    debug_last_end_time: "最后字幕时间",
    debug_deduction_items: "扣分项",
    debug_file_diagnosis: "文件诊断",
