...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--version", action="version", version=f"thunder-subtitle {_get_version()}"
    )
    ...
    p.add_argument(
        "-o", "--output", type=str, default=None, help="Output directory for downloads"
    )
    p.add_argument(
        "-i",
        "--index",
    ...
    p.add_argument(
        "--reset", action="store_true", default=False, help="Reset config to defaults"
    )
    ...
    p.add_argument(
        "--mark", type=str, default=None, help="Mark matching movies as reviewed"
    )
    p.add_argument(
        "--unmark",
        type=str,
    ...
    # ===== scan 命令 =====
    p = subparsers.add_parser(
        "scan", help="Scan Jellyfin movie directories and auto-download subtitles"
    )
    p.add_argument(
        "directory",
        nargs="?",
